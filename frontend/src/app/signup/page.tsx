...
import { Users, CheckSquare, BarChart3, Lock, Globe, Zap, Bell } from "lucide-react";
      ...
      <div className="grid min-h-screen grid-cols-1 lg:grid-cols-2">
        ...
        <div className="relative hidden overflow-hidden bg-gradient-to-br from-indigo-900 via-violet-800 to-purple-900 p-10 text-white lg:flex lg:flex-col lg:justify-between">
          ...
          <div className="relative z-10 flex flex-1 flex-col justify-center">
            <h1 className="mb-3 text-4xl font-semibold leading-tight">Create your account</h1>
            <p className="mb-8 max-w-md text-violet-100">Start your journey to better project management today.</p>
            ...
            <div className="mb-8 rounded-2xl border border-white/10 bg-white/10 p-6 backdrop-blur-sm">
              <div className="mb-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-violet-200">Work together seamlessly</p>
                </div>
              </div>
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="grid size-8 place-items-center rounded-full border-2 border-white/20 bg-white/30 text-xs font-medium">
                    U{i}
                  </div>
                ))}
                <div className="grid size-8 place-items-center rounded-full border-2 border-white/20 bg-white/30 text-xs font-medium">
                  +5
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              {[
                ...
                { icon: BarChart3, text: "Insights & Reports" }
              ].map((item) => (
